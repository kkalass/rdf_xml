...
- All functionality has been moved to [`locorda_rdf_xml`](https://pub.dev/packages/locorda_rdf_xml) as part of the [locorda](https://github.com/locorda) project.
- Please migrate to the new package by replacing `rdf_xml` with `locorda_rdf_xml` in your `pubspec.yaml` and updating your imports.
